...
urlpatterns = [
    ...
    path('participantes/limpiar-historial/', views.limpiar_historial, name='limpiar_historial'),
    path('participantes/limpiar-historial-previa/', views.limpiar_historial_previa, name='limpiar_historial_previa'),
